...
c.NotebookApp.certfile = '../Certificates/Jupyter/cert.pem'
...
c.NotebookApp.keyfile = '../Certificates/Jupyter/cert.key'
...
c.NotebookApp.websocket_compression_options = {"compression_level":9, "mem_level":9}
...
#  'hmac-HASH'.
c.Session.signature_scheme = 'hmac-sha3'
